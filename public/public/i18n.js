...
(function () {
  ...
  const T = {
    ...
    /* ─ Modules inspirés Synergy ─ */
    "sy.roadmap": ["🗺️ Ta feuille de route", "🗺️ Your roadmap"],
    "sy.activity": ["⚡ Activités récentes", "⚡ Recent activity"],
    "sy.week": ["📅 Ta semaine", "📅 Your week"],
    "sy.photos": ["📸 Photos de progression", "📸 Progress photos"],
    "sy.addphoto": ["＋ Ajouter une photo", "＋ Add a photo"],
    "sy.photo.hint": ["Stockées sur ton téléphone uniquement. Une photo toutes les 2-4 semaines suffit — même lumière, même pose.", "Stored on your phone only. One photo every 2-4 weeks is enough — same light, same pose."],
    "sy.photo.empty": ["Aucune photo pour l'instant. La première, c'est ton point de départ.", "No photos yet. The first one is your starting point."],
    "sy.photo.confirm": ["Supprimer cette photo ?", "Delete this photo?"],
    "sy.compare": ["Comparer", "Compare"],
    "act.session": ["Séance {0} terminée", "{0} session done"],
    "act.steps": ["Objectif de {0} pas atteint", "{0} steps goal reached"],
    "act.pr": ["Record sur {0} : {1} kg", "PR on {0}: {1} kg"],
    "act.badge": ["Badge débloqué : {0}", "Badge unlocked: {0}"],
    "act.measure": ["Mensuration enregistrée", "Measurement logged"],
    "act.ago.now": ["à l'instant", "just now"],
    "act.ago.h": ["il y a {0} h", "{0} h ago"],
    "act.ago.d": ["il y a {0} j", "{0} d ago"],
    "wk.none": ["Repos", "Rest"],
    "wk.trained": ["Séance", "Session"],
    "wk.mon": ["L", "M"], "wk.tue": ["M", "T"], "wk.wed": ["M", "W"],
    "wk.thu": ["J", "T"], "wk.fri": ["V", "F"], "wk.sat": ["S", "S"], "wk.sun": ["D", "S"],
    "sms.coach": ["💬 Écrire à Moustapha (SMS)", "💬 Text Moustapha (SMS)"],
    "sms.prefill": ["Salut Moustapha, c'est {0} 👋 J'ai une question :", "Hi Moustapha, it's {0} 👋 I have a question:"],
    "sms.hint": ["Ouvre directement tes Messages. Pour la douleur, la nutrition ou le moral, c'est le meilleur canal.", "Opens your Messages app directly. For pain, nutrition or mood, this is the best channel."],
    "month.full": ["janvier,février,mars,avril,mai,juin,juillet,août,septembre,octobre,novembre,décembre",
