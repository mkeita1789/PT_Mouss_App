...
(function () {
  ...
  const T = {
    ...
    "ex.video": ["▶️ Voir la démo vidéo", "▶️ Watch demo video"],
    "ex.video.note": ["Vidéo de démonstration — usage personnel.", "Demonstration video — personal use."],
    "sy.roadmap": ["🗺️ Ta feuille de route", "🗺️ Your roadmap"],
    "rm.cycleProgress": ["Progression du cycle", "Cycle progress"],
    "rm.weekOf": ["Semaine {0} / {1}", "Week {0} / {1}"],
    "rm.nextPhase": ["Prochaine phase : {0}, dans {1} j", "Next phase: {0}, in {1} d"],
    "rm.lastPhase": ["Dernière phase du cycle — bientôt le retest", "Last phase of the cycle — retest soon"],
    "rm.tapHint": ["Touche une phase pour l'explication · un jour pour ton journal", "Tap a phase for details · a day for your log"],
    "rm.dayLog": ["Ton {0}", "Your {0}"],
    "rm.noSession": ["Pas de séance ce jour-là.", "No session that day."],
    "rm.restDay": ["Jour de repos — ça fait partie du plan.", "Rest day — it's part of the plan."],
    "rm.future": ["À venir", "Upcoming"],
    "rm.sessionDone": ["Séance {0} — {1}", "{0} session — {1}"],
    "rm.loads": ["Charges", "Loads"],
    "rm.checkinDay": ["Check-in", "Check-in"],
